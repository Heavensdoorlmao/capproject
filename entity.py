...
class Entity:
    def __init__(self, game, name):
        self.game = game
        self.name = name
        self.path = f'src/assets/characters/{self.name}'
        self.image = pygame.transform.scale(pygame.image.load(f'{self.path}/{self.name}.png'), utils.basic_entity_size).convert_alpha()
