...
class Player(Entity):
    ...
    hp = max_hp
    items = []
    animation_database = ['src/assets/characters/player/idle/player.png', 'src/assets/characters/player/walk/walk0.png', 'src/assets/characters/player/walk/walk1.png', 'src/assets/characters/player/walk/walk2.png', 'src/assets/characters/player/walk/walk3.png']

    def __init__(self, game):
        Entity.__init__(self, game, self.name)
        self.rect = self.image.get_rect(center=(512 + 2.5 * 64, 600))
        self.hitbox = self.image.get_rect(center=(512 + 2.5 * 64, 600))
        self.weapon = None
