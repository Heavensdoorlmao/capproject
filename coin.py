...
class Coin(Object):
    ...
    def load_image(self):
        for i in range(4):
            image = pygame.image.load(f'src/assets/objects//{self.name}/{self.name}.png').convert_alpha()
...
def play_sound():
    pygame.mixer.Sound.play(pygame.mixer.Sound('src/assets/sound/Coin.wav'))
